 ...
 * 
 * import com.jobConsultancyScheduler.model.User; import
 * com.jobConsultancyScheduler.service.EmailService; import
 * com.jobConsultancyScheduler.service.UserService;
 * 
 *//**
	 * Servlet implementation class ReportController
	 *//*
		 * public class ReportController extends HttpServlet { private static final long
		 * serialVersionUID = 1L;
		 * 
		 * String message = "";
		 * 
		 * private UserService getUserService() { return UserService.getUserService(); }
		 * 
		 ...
		 * 
		 * 
		 * private void generateUserSummaryReport(HttpServletRequest request,
		 * HttpServletResponse response) throws ServletException, IOException { int
		 * userId = Integer.parseInt(request.getParameter("userId")); try { User
		 * consultant = getUserService().fetchSingleUser(userId); if
		 * (consultant.getUserId() > 0) { request.setAttribute("consultant",
		 * consultant); RequestDispatcher rd =
