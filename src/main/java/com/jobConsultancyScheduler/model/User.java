...
public class User {
	...
	public User(int userId, String name, String phoneNumber, String email, String password, String birthdate,
			String gender, String occupation, String country, AccessRight accessRight, String educationalQualifications,
			String specializedCountries, String specializedJobs, String availableDays, String availableTimeSlots,
			String profilePicturePath, String cvPath, RegistrationStatus registrationStatus) {
